...
public class FenwickTree<D extends FenwickTree.Data> {
    ...
    public String toString() {
        ...
        builder.append(FenwickTreePrinter.getString(this).getValue());
        return builder.toString();
    }

    protected static class FenwickTreePrinter {

        public static <D extends FenwickTree.Data> test getString(FenwickTree<D> tree) {
            if (tree.array.length == 0)
                return new test("Tree has no nodes.");
