...
import com.keyin.algorithms.sorts.*;
...
public class Sorts {
    ...
    private static MarkedInteger[] markedIntegers = null;
    ...
    static {
        ...
        markedIntegers = new MarkedInteger[SIZE];

        int i = 0;
        while (i < unsorted.length) {
            int j = RANDOM.nextInt(unsorted.length * 5);
            markedIntegers[i] = new MarkedInteger(j, "N");
            unsorted[i++] = j;
        }
    ...
    public void testInsertionSorts() {
        // Insertion sort
        Integer[] result = InsertionSort.insertSort(unsorted);
    ...
    public void testBubbleSorts() {
        // Bubble sort
        int[] result2 = BubbleSort.bubbleSort(new int[]{5,4,2,1,3});
    ...
    public void testMergeSortsNotInPlace() {
        // Merge sort
        Integer[] result1 = MergeSort.mergeSort(unsorted.clone());
    ...
    public void testQuickSorts() {
        // Quicksort
        QuickSort.quickSort(0, unsorted.length - 1, unsorted);
